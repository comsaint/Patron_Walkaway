...
_FEATURE_SPEC_PATH = _REPO_ROOT / "trainer" / "feature_spec" / "feature_candidates.yaml"
...
class TestScorerReviewRisksRound22(unittest.TestCase):
    ...
    def test_r32_online_features_do_not_use_session_delayed_duration_features(self):
        ...
        Depends on repo feature_candidates.yaml as SSOT (Round 141 Review P2)."""
        self.assertTrue(
            _FEATURE_SPEC_PATH.exists(),
            "Spec YAML required for R32: trainer/feature_spec/feature_candidates.yaml",
        )
