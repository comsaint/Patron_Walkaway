...
| Player-game grain（model + serving completeness） | IP + WP | **active** | [implementation/active/Player-Game Grain…](implementation/active/Player-Game%20Grain%20-%20IMPLEMENTATION_PLAN.md) · [working/active/Player-Game Grain…](working/active/Player-Game%20Grain%20-%20WORKING_PLAN.md) |
