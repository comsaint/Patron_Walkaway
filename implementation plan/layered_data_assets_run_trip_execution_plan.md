...
| **2** | Trip + published | `trip_fact`、`trip_run_map`、published snapshot、late fixture、ingestion gate（**trip 物化：🟡 MVP**；**E2-04 published 指針：🟡 MVP**） |
