"""trainer/etl/etl_player_profile.py — player_profile snapshot ETL
===========================================================================
...
from trainer.db_conn import get_clickhouse_client  # Option A: package entrypoint only; no try/except package-name guessing
...
from .profile_schedule import latest_month_end_on_or_before, month_end_dates
...
# ---------------------------------------------------------------------------
# Paths & constants (under trainer/etl/ so PROJECT_ROOT = repo root)
# ---------------------------------------------------------------------------
...
def _parse_args() -> argparse.Namespace:
    ...
    return build_etl_player_profile_argparser().parse_args()
