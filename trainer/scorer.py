...
# WS4 v2: data-source preflight (ClickHouse) runs inside trainer.serving.scorer.main once at startup.
...
CANONICAL_MAPPING_PARQUET = _impl.CANONICAL_MAPPING_PARQUET
CANONICAL_MAPPING_CUTOFF_JSON = _impl.CANONICAL_MAPPING_CUTOFF_JSON
