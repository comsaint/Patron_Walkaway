...
from trainer.core._config_serving_runtime import (
    ...
    SCORER_REASON_CODES_DEFAULT_EMPTY,
    SCORER_FEATURE_AUDIT_ENABLE,
    SCORER_FEATURE_AUDIT_EVERY_N_CYCLES,
    SCORER_FEATURE_AUDIT_RETENTION_HOURS,
    SCORER_FEATURE_AUDIT_SAMPLE_ROWS,
    SCORER_FEATURE_AUDIT_STORE_VALUES,
...
from trainer.core._config_training_domain import (
    ...
    GBM_BAKEOFF_ENABLE_CATBOOST,
    GBM_BAKEOFF_ENABLE_XGBOOST,
    ...
    OOF_STACKING_ENABLED,
    OOF_STACKING_HOLDOUT_MONTHS,
    OOF_STACKING_MAX_MONTHS,
    OOF_STACKING_MIN_FOLDS,
    OOF_STACKING_MIN_VALID_POSITIVES,
...
from trainer.core._config_training_memory import (
    ...
    GBM_BAKEOFF_CATBOOST_QUANTIZE,
    GBM_BAKEOFF_FROM_FILE,
    GBM_BAKEOFF_XGBOOST_EXTERNAL_MEMORY,
    MIN_VALID_TEST_ROWS,
    ...
    PARALLEL_LDA_BRIDGE_DUCKDB_MEMORY_LIMIT,
    PROFILE_PRELOAD_MAX_BYTES,
    PROFILE_USE_DUCKDB,
    RUN_BOUNDARY_ENGINE,
    RUN_BOUNDARY_PARITY_CHECK,
    RUN_BOUNDARY_PARITY_MAX_ROWS,
    STEP6_PROFILE_ENABLED,
    STEP6_CHUNK_HEALTH_LOG,
    ...
    A3_PHASE_E_PREDICT_HEARTBEAT_EVERY_N_BATCHES,
    A3_PHASE_E_DIAG_MEMORY_SNAPSHOT,
    TRAIN_SPLIT_FRAC,
    VALID_SPLIT_FRAC,
)
from trainer.core._config_high_roller_segmentation import (
    ...
    HIGH_ROLLER_ROOT_SEGMENT_FOR_SERVING,
    HIGH_ROLLER_SEGMENT_ENABLE,
    HIGH_ROLLER_THEO_FEATURE,
)

# Deprecated name: same value as ``HIGH_ROLLER_ROOT_SEGMENT_FOR_SERVING``.
HIGH_ROLLER_PRIMARY_SEGMENT_FOR_SERVING = HIGH_ROLLER_ROOT_SEGMENT_FOR_SERVING
