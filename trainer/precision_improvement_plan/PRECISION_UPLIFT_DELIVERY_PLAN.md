...
- 實作內容：
  ...
  - 更新 feature spec 與必要的 screening（**已**：`feature_spec.yaml`；**待**：deploy 範本與各 bundle 凍結 spec 與訓練預設一致化）。
- DoD：
